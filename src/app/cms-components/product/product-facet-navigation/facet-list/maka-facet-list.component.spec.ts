...
class MockProductListComponentService {
  model$ = of({products: [], pagination: { totalResults: 0 }});
}


describe('MakaFacetListComponent', () => {
  let component: MakaFacetListComponent;
  let fixture: ComponentFixture<MakaFacetListComponent>;
  let element: DebugElement;
  let service: FacetService;
  let productListService: ProductListComponentService;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: ProductListComponentService, useClass: MockProductListComponentService }
      ],
    })
      .overrideComponent(MakaFacetListComponent, {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MakaFacetListComponent);
    ...
    productListService = TestBed.inject(ProductListComponentService);
