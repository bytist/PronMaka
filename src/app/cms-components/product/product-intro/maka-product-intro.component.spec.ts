...
describe('MakaProductIntroComponent in product', () => {
  let productIntroComponent: MakaProductIntroComponent;
  let fixture: ComponentFixture<MakaProductIntroComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [I18nTestingModule],
      declarations: [MakaProductIntroComponent, MockStarRatingComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MakaProductIntroComponent);
