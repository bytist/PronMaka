...
import { MakaNotCheckoutAuthGuard } from './maka-not-checkout-auth.guard';
...
describe('MakaNotCheckoutAuthGuard', () => {
  let guard: MakaNotCheckoutAuthGuard;
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(MakaNotCheckoutAuthGuard);
  ...
  describe('when user is authorized,', () => {
    ...
    it('should redirect to homepage', () => {
      ...
      expect(routing.go).toHaveBeenCalledWith({ cxRoute: 'checkout' });
    });
  });
