...
import { MakaCheckoutAuthGuard } from './maka-checkout-auth.guard';
...
describe('MakaCheckoutAuthGuard', () => {
  let checkoutGuard: MakaCheckoutAuthGuard;
  ...
  beforeEach(() => {
    ...
    checkoutGuard = TestBed.inject(MakaCheckoutAuthGuard);
