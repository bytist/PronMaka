...
describe('MakaUpdatePasswordComponent', () => {
  let component: MakaUpdatePasswordComponent;
  let fixture: ComponentFixture<MakaUpdatePasswordComponent>;
  let el: DebugElement;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MakaUpdatePasswordComponent);
