...
import { MakaUpdatePasswordFormComponent } from './maka-update-password-form.component';

describe('MakaUpdatePasswordFormComponent', () => {
  let component: MakaUpdatePasswordFormComponent;
  let fixture: ComponentFixture<MakaUpdatePasswordFormComponent>;
  let el: DebugElement;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [MakaUpdatePasswordFormComponent],
    }).compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(MakaUpdatePasswordFormComponent);
