...
import { AnonymousConsentLaunchDialogService } from '@spartacus/storefront';
import { MakaAnonymousConsentManagementBannerComponent } from './maka-anonymous-consent-management-banner.component';
...
describe('MakaAnonymousConsentManagementBannerComponent', () => {
  let component: MakaAnonymousConsentManagementBannerComponent;
  let fixture: ComponentFixture<MakaAnonymousConsentManagementBannerComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(
      MakaAnonymousConsentManagementBannerComponent
    );
